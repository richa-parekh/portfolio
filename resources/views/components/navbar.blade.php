    ...
    <div class="max-w-7xl mx-auto px-4 md:px-6">
        <div class="flex items-center justify-between h-20">
            ...
            <div class="hidden md:flex items-center gap-8">
                ...
                > About </a>
                <a href="/contact" class="{{ request()->is('contact') ? 'text-light bg-background-dark font-semibold' : 'text-dark transition' }} font-semibold border-3 border-border-dark px-7 py-1 hover:opacity-90 hover:bg-background-dark hover:text-light font-lato" > Contact </a>
            </div>
